...
function EventChange({className, event, mutationDelete}: EventPropsType): JSX.Element {
    ...
    return (
        <div className={`${styles.event} ${className}`}>
            <div className={styles.content}>
                ...
                <span
                    className={styles.department}>{event.department} {event.note_department && `(${event.note_department})`}</span>
                <span
